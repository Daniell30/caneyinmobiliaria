...
module.exports = class {
  data() {
    ...
    const all = props.filter(x => String(x.area || "").toLowerCase() === "santo domingo");
  ...
  render(data) {
    ...
    // ✅ Fix: compute total pages yourself
  ...
  <script>
    (function(){
      ...
      function renderFiltered(pageIndex){
        ...
        if (idx + 1 < totalPages) html += \`<a href="\${pageHref(0, makeQs(idx+1))}" class="view-details">Ver más</a>\`; // keep base page, carry ?p
